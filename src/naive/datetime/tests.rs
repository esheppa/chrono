...
fn test_datetime_add() {
    ...
    check((2014, 5, 6, 7, 8, 9), OldTimeDelta::seconds(3600 + 60 + 1), Some((2014, 5, 6, 8, 9, 10)));
    check((2014, 5, 6, 7, 8, 9), OldTimeDelta::seconds(-(3600 + 60 + 1)), Some((2014, 5, 6, 6, 7, 8)));
...
fn test_datetime_sub() {
    ...
    assert_eq!(since(ymdhms(2014, 5, 6, 7, 8, 9), ymdhms(2014, 5, 6, 7, 8, 9)), OldTimeDelta::zero());
    assert_eq!(
